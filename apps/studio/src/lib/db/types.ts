...
export interface IBasicDatabaseClient {
  ...
  listTableIndexes(table: string, schema?: string, database?: string): Promise<TableIndex[]>,
  listSchemas(filter?: SchemaFilterOptions): Promise<string[]>,
  getTableReferences(table: string, schema?: string): Promise<string[]>,
  getTableKeys(table: string, schema?: string, database?: string): Promise<TableKey[]>,
  ...
  getTableProperties(table: string, schema?: string, database?: string): Promise<TableProperties | null>,
  ...
  getPrimaryKeys(table: string, schema?: string, database?: string): Promise<PrimaryKeyColumn[]>;
