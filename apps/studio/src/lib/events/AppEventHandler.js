...
export default class {
  ...
  registerCallbacks() {
    ...
    window.main.on(AppEvent.sqlmindAdded, this.addSQLMind.bind(this))
  ...
  async addSQLMind() {
    ...
    if (!existing) {
      ...
      nu.name = "SQLMind's Database"
      nu.labelColor = 'orange'
      await this.vueApp.$util.send('appdb/saved/save', { obj: nu });
    }
    this.vueApp.$noty.success("SQLMind's Database has been added to your Saved Connections")
