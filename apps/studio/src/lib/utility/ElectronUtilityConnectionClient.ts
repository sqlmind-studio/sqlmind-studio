...
export class ElectronUtilityConnectionClient implements IBasicDatabaseClient {
  ...
  async listTableIndexes(table: string, schema?: string, database?: string): Promise<TableIndex[]> {
    return await Vue.prototype.$util.send('conn/listTableIndexes', { table, schema, database });
  }
  ...
  async getTableKeys(table: string, schema?: string, database?: string): Promise<TableKey[]> {
    return await Vue.prototype.$util.send('conn/getTableKeys', { table, schema, database });
  }
  ...
  async getTableProperties(table: string, schema?: string, database?: string): Promise<TableProperties | null> {
    return await Vue.prototype.$util.send('conn/getTableProperties', { table, schema, database });
  }

  async getQuerySelectTop(table: string, limit: number, schema?: string, database?: string): Promise<string> {
    return await Vue.prototype.$util.send('conn/getQuerySelectTop', { table, limit, schema, database });
  }
  ...
  async getPrimaryKeys(table: string, schema?: string, database?: string): Promise<PrimaryKeyColumn[]> {
    return await Vue.prototype.$util.send('conn/getPrimaryKeys', { table, schema, database });
  }
