...
export default class NativeMenuActionHandlers implements IMenuActionHandler {
  ...
  about(): void {
    app.setAboutPanelOptions({
      applicationName: "SQLMind Studio",
      applicationVersion: app.getVersion(),
      copyright: "SQLMind Studio Team",
      authors: ["SQLMind Studio Team", "All the wonderful contributors"],
  ...
  opendocs(): void {
    shell.openExternal("https://sqltools.co/blog")
  }

  contactSupport(): void {
    shell.openExternal("https://sqltools.co/contact")
  }
  ...
  addSQLMind = async (_1: Electron.MenuItem, win: ElectronWindow): Promise<void> => {
    if (win) win.webContents.send(AppEvent.sqlmindAdded)
  }
