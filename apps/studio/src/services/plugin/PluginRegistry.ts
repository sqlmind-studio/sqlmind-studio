...
/** Interface for plugin repository services */
interface IPluginRepositoryService {
  fetchRegistry(): Promise<any>;
  fetchPluginRepository(owner: string, repo: string): Promise<PluginRepository>;
}
...
export default class PluginRegistry {
  ...
  constructor(private readonly repositoryService: IPluginRepositoryService) {}
