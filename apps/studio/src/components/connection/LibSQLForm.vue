<template>
  <div class="libsql-form">
    <div class="alert alert-warning">
      ...
      <span>
        LibSQL support is still in beta. Please report any problems on <a href="https://github.com/sqlmind-studio/sqlmind-studio/issues/new/choose">our issue tracker</a>.
      </span>
    </div>
