      ...
      <div class="row gutter">
        <div class="col form-group">
            ...
            <template>
              <div class="alert alert-info">
                ...
                <span class="flex">
                  ...
                  <a href="https://sqltools.co/docs/sqlite#runtime-extensions">Learn more</a>
                </span>
              </div>
          ...
          >
            ...
            <div>
              Hey snap user! If you want to use a sqlite database on an external drive you'll need to give SQLMind some extra permissions
...
export default Vue.extend({
  ...
  data() {
    return {
      snap: "https://sqltools.co/support/troubleshooting/#i-get-permission-denied-when-trying-to-access-a-database-on-an-external-drive",
