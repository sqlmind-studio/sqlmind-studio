    ...
    <template>
      ...
      >
        ...
        >
          ...
          <div>
            SSH Agent Forwarding is not possible with the Snap version of SQLMind Studio due to the security model of Snap apps.
          ...
          <div class="alert alert-warning">
            ...
            <div>
              Hey snap user! You need to <external-link :href="enableSshLink">
                enable SSH access
              </external-link>, then restart SQLMind to provide access to your .ssh directory.
            </div>
          </div>
        </div>
        <div class="row gutter">
...
export default {
  ...
  data() {
    return {
      enableSshLink: "https://sqltools.co/installation/linux/#ssh-key-access-for-the-snap",
      sshModeOptions: [
