      ...
      <template v-slot:default>
        <div class="row gutter">
          <div class="alert alert-info">
            ...
            <div>
              Providing certificate files is optional. By default SQLMind will just trust the server certificate.
              <external-link href="https://sqltools.co/user_guide/connecting/connecting/#ssl">
                Read More
              </external-link>
            </div>
          </div>
