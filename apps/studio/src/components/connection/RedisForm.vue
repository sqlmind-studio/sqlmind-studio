<template>
  <div class="redis-form">
    <div class="alert alert-warning">
      ...
      <span>
        Redis support is still in beta. Please report any problems on <a href="https://github.com/sqlmind-studio/sqlmind-studio/issues/new/choose">our issue tracker</a>.
      </span>
    </div>
    <!-- Connection Details -->
