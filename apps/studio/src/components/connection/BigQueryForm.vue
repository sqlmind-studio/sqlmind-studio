<template>
  <div class="with-connection-type sqlite-form">
    <div class="alert alert-warning">
      ...
      <span>
        BigQuery support is still in beta. Please report any problems on <a href="https://github.com/sqlmind-studio/sqlmind-studio/issues/new/choose">our issue tracker</a>.
      </span>
    </div>
        ...
        <div class="alert alert-info expand">
          ...
          <span>
            You need a service account with the roles 'BigQuery Data Viewer' and 'BigQuery Job User' - <a
              href="https://sqltools.co/docs/google-bigquery"
            > Read More</a>
          </span>
        </div>
      </div>
