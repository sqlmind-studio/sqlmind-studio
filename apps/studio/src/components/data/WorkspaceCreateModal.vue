<template>
  <modal
    :name="modalName"
    class="vue-dialog sqlmind-modal create-workspace-modal"
    @opened="focus"
  >
    <form @submit.prevent="submit">
      <div class="dialog-content">
        ...
        <div class="form-group">
          ...
          <input id="workspace-name" name="workspace-name" v-model="workspaceName" type="text" ref="nameInput" placeholder="e.g. My Team Workspace">
        </div>
      </div>
