<template>
  ...
  >
    <div class="not-supported">
      <div class="card-flat padding">
        <h3 class="card-title">
          SQLMind does not currently support {{ isRestore ? 'restore' : 'backups' }} for {{ dialect }} ☹️
        </h3>
      </div>
    </div>
  </div>
  ...
  >
    ...
    >
      <modal
        class="vue-dialog sqlmind-modal relative job-status success"
      ...
      <modal
        class="vue-dialog sqlmind-modal relative job-status fail"
