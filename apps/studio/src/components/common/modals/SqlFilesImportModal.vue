<template>
  <modal
    class="vue-dialog sqlmind-modal sql-files-import-modal"
    :name="modalName"
  >
    ...
    <div v-kbd-focus="true">
      <div class="dialog-content">
        ...
        <div class="message">
          This will make a copy of your .sql files and add them to your SQLMind Studio
          saved queries. Any changes to the original .sql files will not be
          reflected in SQLMind Studio.
        </div>
