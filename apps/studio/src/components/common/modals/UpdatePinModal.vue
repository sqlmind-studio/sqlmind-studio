<template>
  <portal to="modals">
    <modal
      ...
      @opened="opened"
      class="vue-dialog sqlmind-modal update-pin-modal"
    >
      <form v-kbd-trap="true" @submit.prevent="submit">
        <div class="dialog-content">
          ...
          <div class="alert alert-info">
            ...
            <div class="alert-body">Your new PIN will be encrypted and stored securely on your device.&nbsp<external-link href="https://sqltools.co/user_guide/configuration#forgot-pin">Forgot your current PIN?</external-link></div>
          </div>
        </div>
