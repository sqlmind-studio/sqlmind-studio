<template>
  <portal to="modals">
    <modal
      ...
      @opened="opened"
      @closed="closed"
      class="vue-dialog sqlmind-modal input-pin-modal"
    >
      <form v-kbd-trap="true" @submit.prevent="submit">
        <div class="dialog-content">
          ...
          <small style="margin-top: 8px; display: block;"><external-link href="https://sqltools.co/user_guide/configuration#forgot-pin" style="text-decoration: underline;">Forgot your PIN?</external-link></small>
        </div>
