<template>
  <portal to="modals">
    <modal
      class="vue-dialog sqlmind-modal upgrade-modal"
      name="upgrade-modal"
      height="auto"
    ...
    >
      ...
      >
        <h3 class="dialog-c-title has-icon">
          <i class="material-icons">stars</i> <span>Upgrade SQLMind Studio</span>
        </h3>
...
export default Vue.extend({
  ...
  methods: {
    ...
    onModalOpened() {
      // Modal opened - no specific focus needed
      // Previously tried to focus on non-existent learnMore element
    }
  },
  mounted() {
